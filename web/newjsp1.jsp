            ...
            <div class="mx-lg-4  card py-0  ">
                ...
                <div class="card-body alert-light mb-5 px-5 mx-4">
                    ...
                    <div class="col-12 col-sm-6 text-right invoice-taxt-mobile">
                        <p class="m-0 p-0 text-muted">Your </p>
                ...
                <div class="card-footer mt-5 alert-secondary px-5 ">
                    ...
                    <div class="col-6 text-right text-muted" ><small>rkpro221@gmail.com | 8806723456 | RkRent.com</small></div>
                    </div>
                </div>
